            ...
            <div class={mobileContentClass}>
                {#if showDesktopCloseButton}
                    <button
                        ...
                        class="hidden sm:flex absolute top-4 right-4 w-9 h-9 bg-gray-200 hover:bg-gray-300 items-center justify-center rounded-full transition-colors duration-200 z-50"
                    >
